...
describe("AzureCredentialProvider", () => {
    ...
    describe("getBearerTokenProvider", () => {
        it("should create bearer token provider with default scope", () => {
            ...
            expect(getBearerTokenProvider).toHaveBeenCalledWith(mockCredential, "https://cognitiveservices.azure.com/.default");
        ...
        it("should throw error when token provider creation fails", () => {
            ...
            expect(() => provider.getBearerTokenProvider()).toThrow("Failed to create bearer token provider: Token provider creation failed");
        });
    });
